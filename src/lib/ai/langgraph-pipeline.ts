...
export async function runResearchPipeline(
  ...
  const normalizedCompanyData = {
    ...
    faceValue: result.financials.faceValue ?? rawCompanyData.faceValue,
  };
  ...
  return {
    ...
    highLow52W: result.financials.highLow52W,
    enterpriseValue: result.financials.enterpriseValue,
    ev: result.financials.ev,
    outstandingShares: result.financials.outstandingShares,
    freeFloat: result.financials.freeFloat,
    dividendYield: result.financials.dividendYield,
    avgVolume6m: result.financials.avgVolume6m,
    avgVolume: result.financials.avgVolume,
    beta: result.financials.beta,
    faceValue: result.financials.faceValue,
